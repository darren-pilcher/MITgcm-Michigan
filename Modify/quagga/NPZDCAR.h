...
c
       ...
       _RL   quagga(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
c     &       remint, reminr,
     ...
     &       wn_sink, ws_sink, wf_sink, wc_sink, wpic_sink, wphy2_sink,
     ...
     &       thetam, thetar, fexc,
     &       temp_zoo_norm, temp_zoo_base,
     &       fracsrp, fracdop, fracpop,
     &       donfracq, qplat, qplat2,
...
c       _RL   remint, reminr
       ...
       _RL   wn_sink, ws_sink, wf_sink, wc_sink, wpic_sink, wphy2_sink
       ...
       _RL   chlcmax, chlcmin
       _RL   thetam, thetar, fexc
       _RL   temp_coeff_base, temp_coeff_norm
       _RL   temp_zoo_norm, temp_zoo_base
       _RL   fracsrp, fracdop, fracpop
       _RL   donfracq, qplat, qplat2
       _RL   quaggagraze, quaggagraze2

c air-sea flux info
       COMMON /NPZDCAR_PARM03/
     &  FluxCO2, FluxO2, pH, pCO2, AtmospCO2, VirtualFlux,
	...
	_RL  pCO2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx, nSy)
        _RL  VirtualFlux(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
c  
       ...
       _RL  Cgrow1ave(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nR,nSx, nSy)
       _RL  Cgrow2ave(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nR,nSx, nSy)
       ...
       _RL  virtCO2fluxave(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx, nSy)
       _RL  NPZD_timeave(nR,nSx,nSy)
       _RL  Quaggagrazave(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nR,nSx, nSy)
#ifdef PTR_CALC_TERMS
