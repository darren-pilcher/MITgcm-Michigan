...
C     the_run_name    :: string identifying the name of the model "run"
     ...
     &                mdsioLocalDir, 
     &                the_run_name
     &               ,fCoriCFile, fCoriGFile, fCorCsFile ! <-- added Coriolis parameters
      ...
      CHARACTER*(MAX_LEN_FNAM) fCoriCFile ! <-- added Coriolis parameters
      CHARACTER*(MAX_LEN_FNAM) fCoriGFile ! <-- added Coriolis parameters
      CHARACTER*(MAX_LEN_FNAM) fCorCsFile ! <-- added Coriolis parameters
      CHARACTER*(6) eosType
...
C Logical flags for selecting packages
      ...
      LOGICAL useLAKEICE ! added
C      LOGICAL useRIVERS ! added
